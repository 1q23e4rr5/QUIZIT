    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('correct_option', models.IntegerField(choices=[(1, 'گزینه ۱'), (2, 'گزینه ۲'), (3, 'گزینه ۳'), (4, 'گزینه ۴')], verbose_name='گزینه صحیح')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hearts_last_update', models.DateTimeField(default=django.utils.timezone.now)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('selected_option', models.IntegerField(choices=[(1, 'گزینه ۱'), (2, 'گزینه ۲'), (3, 'گزینه ۳'), (4, 'گزینه ۴')], verbose_name='گزینه انتخاب شده')),
                ('is_correct', models.BooleanField(default=False, verbose_name='صحیح/غلط')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Users.question', verbose_name='سوال')),
